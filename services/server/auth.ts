...
export type AuthFlowErrorCode =
  ...
  | 'facility_persistence_failed'
  | 'facility_schema_unavailable'
  | 'request_timeout'
  | 'service_unavailable'
  | 'payload_validation_failed'
  | 'employee_payload_validation_failed'
  ...
  | 'employee_invite_resend_unsupported'
  | 'employee_auth_lookup_failed'
  | 'employee_auth_user_exists'
  | 'employee_auth_user_not_found'
  | 'employee_auth_duplicate'
  | 'employee_auth_connection_failed'
