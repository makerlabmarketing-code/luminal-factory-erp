-- Corrective Slice 6 Production Order Persistence approved migration.
-- Production execution path: Supabase GitHub Integration after protected main-branch merge.
-- Rollback and validation remain separate artifacts under supabase/drafts/corrective-slice-6-production-order-persistence/.

-- BEGIN REVIEWED PACKAGE: forward.sql
...
commit;
-- END REVIEWED PACKAGE: forward.sql

-- BEGIN REVIEWED PACKAGE: notification-outbox.sql
...
commit;
-- END REVIEWED PACKAGE: notification-outbox.sql

-- BEGIN REVIEWED PACKAGE: compatibility.sql
...
commit;
-- END REVIEWED PACKAGE: compatibility.sql

-- BEGIN REVIEWED PACKAGE: attachment-policy.sql
...
commit;
-- END REVIEWED PACKAGE: attachment-policy.sql

-- BEGIN REVIEWED PACKAGE: security/RLS.sql
...
commit;
-- END REVIEWED PACKAGE: security/RLS.sql
