...
revoke all on function public.staff_attendance_multi_mutation(text,date,text,time without time zone) from public, anon, authenticated;
...
drop function if exists public.staff_attendance_multi_mutation(text,date,text,time without time zone);
